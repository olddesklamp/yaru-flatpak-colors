...
class CustomAccentColorsPrefsWidget extends Adw.PreferencesPage {
    ...
    constructor() {
        ...
        listModel.append(new CustomAccentColors('Ubuntu', 'ubuntu'));
        listModel.append(new CustomAccentColors('Blue', 'blue'));
        listModel.append(new CustomAccentColors('Bark', 'bark'));
        listModel.append(new CustomAccentColors('Olive', 'olive'));
        listModel.append(new CustomAccentColors('Prussian Green', 'prussiangreen'));
        listModel.append(new CustomAccentColors('Purple', 'purple'));
        listModel.append(new CustomAccentColors('Red', 'red'));
        listModel.append(new CustomAccentColors('Saga', 'saga'));
        listModel.append(new CustomAccentColors('Viridian', 'viridian'));
